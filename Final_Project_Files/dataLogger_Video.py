...
if __name__=='__main__':
    ...
    while True:
        ...
        # Get video frame for detection results from yolo and bytetrack 
        ret, frame = cap.read()
        if not ret:   # video is finished
            break

        # Get detection results from yolo and bytetrack
        results = model.track(frame, persist=True, show=False, tracker="bytetrack.yaml", show_labels=False, show_conf=False, save=False)
